...
from .sam3_mask_stabilizer import NODE_CLASS_MAPPINGS as STABILIZER_MAPPINGS
from .sam3_mask_stabilizer import NODE_DISPLAY_NAME_MAPPINGS as STABILIZER_DISPLAY_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(STABILIZER_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(STABILIZER_DISPLAY_MAPPINGS)
